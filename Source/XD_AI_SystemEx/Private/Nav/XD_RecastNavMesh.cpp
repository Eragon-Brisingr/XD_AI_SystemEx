...
// 						}
						...
						UKismetSystemLibrary::LineTraceSingle(World, EdgeStepVertex, EdgeStepVertex - FVector(0.f, 0.f, 40.f), JumpPointTraceChannel, false, {}, DrawDebugTrace, StartHitResult, false);
						...
						for (float StepDistance = JumpMaxDistance; StepDistance > JumpDistanceStepLength; StepDistance -= JumpDistanceStepLength)
						{
							...
							UKismetSystemLibrary::SphereTraceMulti(World, StartTraceLocation, EndTraceLocation, JumpDistanceStepLength / 2.f, JumpPointTraceChannel, false, IgnoreActors, DrawDebugTrace, HitResults, false);
...
// 									UKismetSystemLibrary::CapsuleTraceSingle(World, StartLocation + FVector(0.f, 0.f, HalfAgentHeight), TargetLocation + FVector(0.f, 0.f, HalfAgentHeight), , AgentHeight)

									NavigationLink.Direction = StartLocation.Z - TargetLocation.Z < JumpMaxHeight ? ENavLinkDirection::BothWays : ENavLinkDirection::LeftToRight;
									NavigationLink.SnapRadius = JumpPointMinDistance / 2.f;
									NavigationLink.SetAreaClass(JumpNavArea);
									NavDataExtra->PointLinks.Add(NavigationLink);
