...
#include "XD_BehaviorTreeNodeEditMode.generated.h"

class FPrimitiveDrawInterface;

// This class does not need to be modified.
UINTERFACE(MinimalAPI, meta = (CannotImplementInterfaceInBlueprint))
class UXD_BehaviorTreeNodeEditMode : public UInterface
{
	GENERATED_BODY()
};
 ...
 * 
 */
class XD_AI_SYSTEMEX_API IXD_BehaviorTreeNodeEditMode
{
	GENERATED_BODY()
